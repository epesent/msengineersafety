        ...
        <div id="mbodyright1">
            <div id="mbr1content">
                ...
                <div class="rowL" style="margin-top: 10px">
                    ...
                    <div class="col-md-4"><u>Name:</u></div><!--end grid div-->
                    <div class="col-md-7"><u>Description:</u></div><!--end grid div-->
                </div><!--end rowL-->
                <?php foreach ($compDocs AS $rowC) {?>
                    <div class="rowL">
                        ...
                        <div class="col-md-7"><h4><?php echo $rowC['description']; ?></h4></div><!--end grid div-->
                    </div><!--end rowL-->
                <?php } ?>
                ...
                <?php foreach ($extDocs AS $rowE) {?>
                    <div class="rowL">
                        ...
                        <div class="col-md-7"><h4><?php echo $rowE['description']; ?></h4></div><!--end grid div-->
                    </div><!--end rowL-->
                <?php } ?>
